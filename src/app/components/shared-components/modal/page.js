...
const Modal = ({open, setOpen, setIsUserCreated}) => {
  ...
  return (
    <div show={open}>
      <Dialog as="div" className="relative z-10" open={open || false} initialFocus={cancelButtonRef} onClose={() => setOpen(false)}>
        <div
          show={open}
          as={Fragment}
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 width-modal">
